...
public class UserTypeProvider extends ContentProvider {

    private LeaveSysDB leaveSysDB;
    private UserTypeDao userTypeDao;

    private static final int USERTYPE_TABLE = 1;
    private static final int USERTYPE_TABLE_ROW = 2;
    private static final int USERTYPE_SQL = 3;
    private static final int USERTYPE_SQL_ROW = 4;
    private static final UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);

    static {
        uriMatcher.addURI("com.wfql.server.provider.UserTypeProvider", "UserType/all", USERTYPE_TABLE);
        uriMatcher.addURI("com.wfql.server.provider.UserTypeProvider", "UserType/all/#", USERTYPE_TABLE_ROW);
        uriMatcher.addURI("com.wfql.server.provider.UserTypeProvider", "UserType/sql", USERTYPE_SQL);
        uriMatcher.addURI("com.wfql.server.provider.UserTypeProvider", "UserType/sql/#", USERTYPE_SQL_ROW);
    }
    ...
    public boolean onCreate() {
        ...
        leaveSysDB = Room.databaseBuilder(context, LeaveSysDB.class, "LeaveSysDB")
                ...
                .addMigrations()
                .build();
        userTypeDao = leaveSysDB.userTypeDao();
        return true;
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (match) {
            ...
            case USERTYPE_SQL:
                ...
                cursor = userTypeDao.queryByExecSql(query);
                break;
